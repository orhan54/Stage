...
<body>
    <div class="container-fluid">
        <div class="row align-items-center">
            ...
            <div class="col-12 col-lg-6">
                <img id="logo" src="/PHP/Stage/public/image/logo.png" alt="logo">
            </div>
            <div id="btnCreeCompte" class="col-3 d-flex justify-content-end">
                <a href="/PHP/Stage/src/view/createChoose.php" class="btn btn-primary me-2 w-100 w-md-50">Créer compte</a>
                <a href="/PHP/Stage/src/view/login.php" class="btn btn-primary me-2 w-100 w-md-50">Connexion</a>
            </div>
        </div>
    </div>
    ...
    <footer class="d-flex justify-content-end align-items-end" style="height: 38vh;">
        <img class="mb-4 me-4" id="drapeau" src="/PHP/Stage/public/image/drapeau-france-ukraine.avif" alt="drapeau">
    </footer>
