...
<section>
    <p class="col-lg-8 offset-lg-1 mt-5">
...
<h4 class="col-lg-6 offset-lg-3 offset-xxl-3 mt-5">Les offres d'emploi</h4>
    ...
    <div class="col-4 offset-1">
        ...
        <a href="#" style="text-decoration: none; color: inherit;">
            ...
            <div class="ms-3 mt-3">
                ...
                <p><i class="bi bi-send-fill"></i> Canditature simplifiée</p>
                </a>
                <div class="mb-5">
                <ul>
                    <li class="col-10">Entité de rattachement Specialisée dans le domaine de la protection incendie depuis 1932, DESAUTEL est un groupe familial employant plus de 1600 salariés.</li>
                </ul>
                </div>
                <p class="text-muted" style="position: absolute; bottom: 0; left: 10;">Annonce</p>
            </div>
        ...
        <div class="card mt-5">
            <div class="ms-3 mt-3">
                ...
                <a href="https://www.auchan.fr/magasins/hypermarche/auchan-hypermarche-laxou/s-119?utm_source=gmb">
                    <p>Auchan Hypermarché SAS <i class="bi bi-box-arrow-up-right"></i>
                </a><strong> . 3,6 </strong><i class="bi bi-star-fill"></i></p>
                <p>54000 Nancy</p>
                <div class="row">
                ...
                <hr>
                <div id="detail-emploi" class="scroll-container" style="max-height: 410px; overflow-y: auto;">
                    ...
                    <p><strong>Auchan Retail France, une entreprise de distribution de plus de 50 000 collaborateurs au service de millions de clients chaque années.</strong></p>
                    ...
                    <ul>
                        ...
                        <li><strong>Garantir un service client de qualité,</strong> en étant moteur du développement de l'expérience client, et en accompagnant les collaborateurs
                            dans le style relationnel Auchan au travers d'une relation authentique et de proximité.
                        </li>
                        <li><strong>Assurer la fidélisation et le respect des engagements clients,</strong> vous traitez les réclamations et analysez les enquêtes clients dans
                            le but de mettre en place des actions améliorant la satisfaction client.
                        </li>
                        <li><strong>Piloter au quotidien votre ligne de caisses,</strong> en maintenant le matériel en bon état de fonctionnement, en facilitant le passage
                            en caisse, et en veillant à la propreté de la ligne. Vous êtes également garant de la tenue quotidienne du coffre :
                            comptabilité, gestion du fonds de caisse, respect des procédures, etc.
                        </li>
                        ...
                        <p>Chez Auchan, nous sommes convaincus que la diversité fait la richesse d’une entreprise. Nous étudions à compétences égales chaque candidature et
                            toutes nos offres peuvent faire l’objet d’aménagements spécifiques en cas de handicap - #tous égaux, tous différents !
                        </p>
                        ...
                        <hr>
                        <a class="btn btn-secondary text-black" href=""><i class="bi bi-flag-fill me-3"></i><strong>Signaler l'offre</strong></a>
                </div>
                </ul>
            </div>
        </div>
